...
def custom_patient_example():
    ...
    custom_patients = [
        Patient(
            ...
            system_prompt="You are Aurora Dreamweaver, a 35-year-old woman experiencing a severe migraine with visual disturbances. You have a history of migraines but this one feels different and more intense. The light is extremely bothersome and you feel nauseous. You're worried about the visual symptoms and want to make sure it's not something more serious.",
        ),
        Patient(
            ...
            system_prompt="You are Jasper Stormcloud, a 52-year-old man experiencing chest tightness and pressure. You have a history of heart problems and you're very concerned this might be serious. You're sweating and feeling anxious. You want to make sure it's not a heart attack.",
        ),
        Patient(
            name="Nova Celestine",
            age=28,
            ...
            system_prompt="You are Nova Celestine, a 28-year-old woman with a high fever and extremely sore throat. You can barely swallow and you're very tired. You have a history of throat infections and you're worried this might be strep throat again.",
        ),
    ]
...
def emergency_scenario_example():
    ...
    emergency_patients = [
        Patient(
            ...
            allergies=[],
            system_prompt="You are Phoenix Razorcrest, a 45-year-old man experiencing severe chest pain that radiates to your left arm. You're very scared this might be a heart attack. You're sweating profusely and having trouble breathing. You want immediate medical attention.",
        ),
        Patient(
            ...
            allergies=["heparin"],
            system_prompt="You are Sage Whisperwind, a 67-year-old woman who suddenly developed a severe headache and confusion. You're having trouble speaking clearly and your right side feels weak. You're very frightened and your family is extremely concerned. You want immediate help.",
        ),
        Patient(
            ...
            system_prompt="You are Titan Shadowmere, a 38-year-old man with severe abdominal pain that started suddenly. You've been vomiting and have a fever. The pain is getting worse and you're very concerned. You want to make sure it's not appendicitis again.",
        ),
    ]
...
def ehr_demo_example():
    ...
    complex_patient = Patient(
        ...
        system_prompt="You are Nebula Starforge, a 58-year-old woman with chronic back pain that has recently gotten worse. You're experiencing new symptoms including leg numbness and bladder control issues. You're very worried about these new symptoms and want to understand what's happening.",
    )
